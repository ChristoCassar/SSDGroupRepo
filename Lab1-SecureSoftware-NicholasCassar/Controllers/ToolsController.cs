...
namespace Lab1_SecureSoftware_NicholasCassar.Controllers
{
    public class ToolsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Type,Description,SerialNumber,Cost,InUse")] Tool tool)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("Id,Name,Type,Description,SerialNumber,Cost,InUse")] Tool tool)
        {
            if (id != tool.Id)
            {
                return NotFound();
